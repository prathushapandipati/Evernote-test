...
public class HomePage extends BasePage {
  ...
  @FindBy(xpath = "//*[@id='qa-HOME_NOTE_WIDGET_NOTE_LIST_2|0_0|0_MB7DU3|13']/article[1]/div[1]")
  @CacheLookup
  ...
  @FindBy(xpath = "//*[@id='qa-NAV_HOME']")
  @CacheLookup
  WebElement move_to_home;
  ...
  public void writeSomeTextInNote(String noteText) throws InterruptedException {
    txt_note.sendKeys(noteText);
    Thread.sleep(5000);
  }

  public void logoutFromEvernoteApp() throws InterruptedException {
  ...
  public void verifyContentInTheNote(String message) {
    ...
    if (!driver.getPageSource().contains(message)) {
      throw new IllegalStateException(
          "This is not the note text that we are looking for. The Current page is" + driver.getCurrentUrl());
    }
    driver.switchTo().parentFrame();
  }

  public void moveNoteToTrash() throws InterruptedException {
    more_actions.click();
  ...
  public void verifyLoginIsSuccessful() {
    ...
    if (!driver.getPageSource().contains("Create new note")) {
      throw new IllegalStateException(
          "This is not the login success page. The Current page is" + driver.getCurrentUrl());
    }
  }
}
